  ...
  return (
    <div className="mt-10 bg-white shadow-sm ring-1 ring-gray-900/5 sm:rounded-lg">
      <div className="px-4 py-5 sm:p-6">
        <h3 className="text-base font-semibold leading-6 text-gray-900">Fazer nova doação</h3>
        <div className="mt-2 max-w-xl text-sm leading-6 text-gray-500">
          <p>
            Continue apoiando o Fundo Patronos e contribuindo para o futuro da educação na Unicamp.
            Sua generosidade transforma vidas e impulsiona a inovação.
          </p>
        </div>
        <div className="mt-5">
          <a
        ...
        <div className="mt-4 rounded-md bg-gray-50 p-4">
          <p className="text-sm leading-6 text-gray-600">
            <span className="font-semibold text-gray-900">Doação via PIX:</span>{' '}
