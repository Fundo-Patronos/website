...
// Sobre Nós submenu items
const aboutItems = [
  { name: 'Nossa História', description: 'Conheça a trajetória do Fundo Patronos', href: '#', icon: BuildingLibraryIcon },
  { name: 'Missão e Visão', description: 'Nossos valores e objetivos', href: '#', icon: AcademicCapIcon },
  { name: 'Equipe', description: 'Conheça nosso time dedicado', href: '#', icon: UsersIcon },
  { name: 'Governança', description: 'Estrutura e transparência', href: '#', icon: FingerPrintIcon },
]
    ...
    <header className="bg-white">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-12">
          <a href="#" className="text-sm font-semibold leading-6 text-gray-900 hover:text-blue-900 transition-colors">
            Home
          </a>
          
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-sm font-semibold leading-6 text-gray-900 hover:text-blue-900 transition-colors">
              Sobre Nós
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" className="rounded-md bg-blue-900 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-900 transition-colors">
              ...
              <div className="space-y-2 py-6">
                ...
                <Disclosure as="div" className="-mx-3">
                  ...
                  <DisclosurePanel className="mt-2 space-y-2">
                    {[...aboutItems, ...callsToAction].map((item) => (
                      <DisclosureButton
                        key={item.name}
                        as="a"
                        href={item.href}
