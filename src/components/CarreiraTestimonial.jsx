export default function CarreiraTestimonial() {
  return (
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote className="text-xl/8 font-semibold text-gray-900 sm:text-2xl/9">
              <p>
                Acredito que a educação muda destinos, mas é o acesso a oportunidades que permite que novas histórias sejam escritas. E, para mim, o Fundo Patronos representou exatamente isso: uma oportunidade de me preparar, de acreditar no meu potencial e de enxergar caminhos que antes pareciam distantes.
              </p>
            </blockquote>
          </div>
          <div className="col-end-1 w-16 lg:row-span-4 lg:w-72">
            <img
              alt=""
              src="/Centro%20de%20Carreiras/josiane-profile-pic.jpeg"
              className="rounded-xl bg-indigo-50 lg:rounded-3xl"
            />
          </div>
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            <div className="font-semibold text-gray-900">Josiane Aragão</div>
            <div className="mt-1 text-gray-500">Estudante de Engenharia Agrícola, Unicamp</div>
          </figcaption>
        </figure>
      </div>
    </section>
