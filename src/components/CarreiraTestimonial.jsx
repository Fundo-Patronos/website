export default function CarreiraTestimonial() {
  return (
    <div className="bg-white pt-12 pb-8 sm:pt-16 sm:pb-12 xl:pb-16">
      <div className="pb-20 sm:pb-24 xl:pb-0" style={{background: 'linear-gradient(135deg, #ff9700, #ff6253, #fc4696, #c964e2)'}}>
          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              ...
              <figcaption className="mt-8 text-base">
                ...
                <div className="mt-1 text-gray-400">Ex-estudante da Unicamp, Engenheira de Software</div>
              </figcaption>
            </figure>
          </div>
        </div>
