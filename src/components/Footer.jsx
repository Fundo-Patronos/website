      ...
      <div className="mx-auto max-w-7xl px-6 pt-16 pb-8 sm:pt-24 lg:px-8 lg:pt-32">
        ...
        <div className="mt-16 border-t border-gray-900/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          ...
          <form className="mt-6 sm:flex sm:max-w-md lg:mt-0">
            ...
            <input
              ...
              autoComplete="email"
              className="w-full min-w-0 rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus-visible:outline-blue-600 sm:w-56 sm:text-sm leading-6"
            />
            <div className="mt-4 sm:mt-0 sm:ml-4 sm:shrink-0">
              <button
                type="submit"
                className="flex w-full items-center justify-center rounded-md bg-blue-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                Inscrever-se
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-gray-900/10 pt-8 md:flex md:items-center md:justify-between">
          ...
          <p className="mt-8 text-sm leading-6 text-gray-600 md:order-1 md:mt-0">
            &copy; 2025 Fundo Patrimonial Patronos - Universidade Estadual de Campinas. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
