...
function TrilhaDeCarreiras() {
  const stats = [
    { label: 'Duplas Formadas', value: '+400' },
    { label: 'Sessões de Mentoria', value: '3' },
  ...
  const paragraphs = [
    ...
    'Formato híbrido e acessível a todos os cursos da Unicamp. Prepara estudantes para processos seletivos e decisões de carreira através de orientações personalizadas, oferecendo ferramentas estratégicas para alcançar objetivos profissionais com direcionamento especializado.'
  ]
  ...
  const faqs = [
    ...
    {
      question: "Qual o compromisso assumido? (Para Mentores)",
      answer: "Os mentores deverão ter sessões mensais de aproximadamente 1h com seus mentorados nos meses de Agosto a Dezembro (3 sessões no total)."
    },
    {
    ...
    {
      question: "A inscrição garante a seleção para o programa? (Para Mentores)",
      answer: "Não. É possível que haja mais mentores inscritos do que necessário para a formação das duplas. Assim, existe a possibilidade da não participação. Mas seu perfil ficará no banco de mentores para outras oportunidades no Patronos."
    }
  ]
  ...
  return (
    <div className="min-h-screen">
      <ImpactoHero
        ...
        primaryButtonLink="https://tally.so/r/Y59vZ5"
        secondaryButtonText="Inscrição de Mentores"
        secondaryButtonLink="https://tally.so/r/gDz10l"
      />
      <ImpactoAbout
